...
import { hasPublicTranscriptionProcessor, transcribeAudio } from "./lib/transcription-client";
...
function AnalysisV2() {
  ...
  async function requestTranscription(file:File):Promise<MusicProcessingResult>{if(isStaticSite&&!hasPublicTranscriptionProcessor())return {provider:"GitHub Pages browser mode",mode:"fallback",warnings:["未配置公开的扒谱服务，因此没有生成音符或 MusicXML。"]};return transcribeAudio(file,{targetInstrument:targetForApi()})}
